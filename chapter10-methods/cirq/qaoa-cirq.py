"""QAOA in Cirq for an Ising Hamiltonian."""
...
def optimize(init_val):
    """Returns the best parameter values."""
    pass
...
if __name__ == "__main__":
    ...
    gammavals = np.linspace(0, 1, 20)
    betavals = np.linspace(0, np.pi, 20)
    ...
    print("\nMinimum cost =", cost([gamma_opt], [beta_opt]))
    
    # =======================================
    # Sample from the circuit at these values
    # =======================================
